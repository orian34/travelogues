...
### Back for the End
It might not seem like it, but it's been more than a month since last time. [Elden Ring swept by]({{ site.baseurl }}/eldenring/) and only now am I back to it! It takes a while to get familiar with all my setups again... After my mind clears up enough, I aim for what I stopped at - making the nether token. Playing around with fuels yields all I need to make it, and finally I enter the Nether.
